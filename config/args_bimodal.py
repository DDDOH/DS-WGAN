...
def get_args(rest_args):
    ...
    parser.add_argument('--dataset', type=str, default='bimodal')
    ...
    # if --dataset is 'uniform' or 'bimodal', num of intervals in training set
    parser.add_argument('--n_interval', type=int, default=16)
    ...
    parser.add_argument('--eval_multi_server_queue', type=bool, default=False)
